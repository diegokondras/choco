...
$fileLocation = Join-Path $toolsDir 'vlibras_instalador_6.0.0.exe'
...
$packageArgs = @{
  ...
  softwareName  = 'vlibras*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
